    ...
    public int[] sortJumbled(int[] mapping, int[] nums) {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            while (originalNum > 0) {
                ...
                mappedNum += placeValue * mapping[digit]; // Map the digit and add to mappedNum considering the place
                                                          // value.
        ...
        Arrays.sort(mappedWithIndex, (a, b) -> a[0] == b[0] ? a[1] - b[1] : a[0] - b[0]); // If mapped numbers are
                                                                                          // equal, compare index.
