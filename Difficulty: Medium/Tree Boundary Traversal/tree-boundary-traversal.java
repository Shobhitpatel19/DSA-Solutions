...
class Solution {
    ArrayList<Integer> boundaryTraversal(Node node) {
        ...
        if (!isLeaf(node)) result.add(node.data); // Root node (if not a leaf)
    ...
    // Collect leaf nodes using inorder traversal
    ...
    // Collect right boundary (excluding leaf nodes, added in reverse order)
